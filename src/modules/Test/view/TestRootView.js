...
*/
@withRouter
export default class TestRootView extends Component {
  constructor(props) {
    super(props);
  }
  handleClick = () => {
  ...
  render() {
    return (
      <div className="test-container">
        <div onClick={() => TestActions.increase()}>{this.props.testValue}</div>
        <button onClick={this.handleClick}>点击回到 home page</button>
        <br/>
        <button onClick={this.handleClickTwo}>点击回到 homeTwo page</button>
        <TestForm>
